...
public class Client  {
    ...
    void sendLocation(Location loc) {
        try {
            sOutput.writeObject(loc);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    void sendSingle(SingleMessage message) {
        try {
                    ...
                    if(object instanceof SingleMessage) {
                        ...
                        if (message.getTo().equals(Network.clientString) && !message.isCanChat()) {
                            ...
                            Platform.runLater(() -> {
                                    ...
                                    alert.setContentText(message.getFrom() + " want's to have a chat with you.");
